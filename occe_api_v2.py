...
class Occe:
    ...
    def get_open_orders(self, pair):
        ...
        :type: dict
        """
        req = self.call_api('account/orders/open/' + pair.upper())
        return req
    ...
    def get_orders_history(self, pair):
        ...
        :type: dict
        """
        req = self.call_api('account/orders_history/' + pair.upper())
        return req
    ...
    def cancel_order(self, pair, order_id):
        ...
        :type: dict
        """
        req = self.call_api(pair.upper() + '/orders' + str(order_id), get=False, delete=True)
        return req
    ...
    def create_order(self, market, order_type, amount, price):
        ...
        data = dict(type=order_type.upper(),
                    amount=amount,
                    price=price,
                    balanceVersion=balance_version)

        req = self.call_api(market.upper() + '/orders', params=data, get=False)
        return req
    ...
    def get_trade_history(self, pair=None):
        ...
        """
        if pair:
            req = requests.get(self.api_url_public + 'info/' + pair.upper())
        else:
    ...
    def get_market_orders(self, pair):
        ...
        :type: dict
        """
        req = requests.get(self.api_url_public + 'orders/' + pair.upper())
        return req.json()
...
if __name__ == '__main__':
    ...
    try:
        print(type(occe.get_server_time()))
